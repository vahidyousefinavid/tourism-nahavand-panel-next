...
interface EditCustomerModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (customer: UpdateCustomerDto) => void;
  customer: Customer | null;
}

export function EditCustomerModal({ isOpen, onClose, onSubmit, customer }: EditCustomerModalProps) {
  ...
  useEffect(() => {
    if (customer && isOpen) {
      setFormData({
        ...
        dateOfBirth: format(new Date(customer.dateOfBirth), 'yyyy-MM-dd'),
