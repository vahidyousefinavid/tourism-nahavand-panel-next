      ...
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-1">
            ...
            <DialogTitle className="text-lg font-bold text-gray-900">حذف فرصت سرمایه‌گذاری</DialogTitle>
          </div>
          <DialogDescription className="text-gray-600 text-sm leading-relaxed">
            آیا از حذف <span className="font-semibold text-gray-800">«{name}»</span> اطمینان دارید؟
            <br />
